AGENT_GENERATOR_REGISTRY = {
    ...
    "hermes_codeact_agent.HermesOHCodeActAgent": "skyrl_agent.agents.base.AgentRunner",
...
AGENT_TRAJECTORY_REGISTRY = {
    ...
    "hermes_codeact_agent.HermesOHCodeActAgent": "skyrl_agent.agents.oh_codeact.CodeActTrajectory",
